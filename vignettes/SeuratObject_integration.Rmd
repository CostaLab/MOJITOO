...
wget --no-verbose  https://www.dropbox.com/s/s2lwq3dsi7eyjga/PBMC-Multiom_annotation.tsv
```
...
```
![UMAP](assets/PMBC_Multiome_subset/UMAP.png)
...
![FeaturePlot](assets/PMBC_Multiome_subset/FeaturePlot.png)
...
![Heatmap1](assets/PMBC_Multiome_subset/Heatmap1.png)
![Heatmap2](assets/PMBC_Multiome_subset/Heatmap2.png)

### Tracks
```{r CCTracks}
#wget --no-verbose https://www.dropbox.com/s/ko75p2q5kimvzl7/genes.gtf.zip
#unzip genes.gtf.zip
#wget --no-verbose https://www.dropbox.com/s/nluhbbhm148nwt7/bigwig.zip
#unzip bigwig.zip
data_track_bws <- list(
...
```
![tracks](assets/PMBC_Multiome_subset/Tracks.png)
